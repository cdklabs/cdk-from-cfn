...
namespace ConfigConstruct
{
    public class ConfigConstructProps
    {
    ...
    public class ConfigConstruct : Construct
    {
        ...
        public ConfigConstruct(Construct scope, string id, ConfigConstructProps props = null) : base(scope, id)
        {
            // Applying default props
            props ??= new ConfigConstructProps();
            ...
            {
                BucketName = $"cdk-from-cfn-e2e-test-config-bucket-{Stack.Of(this).Account}-{Stack.Of(this).Region}",
            });
