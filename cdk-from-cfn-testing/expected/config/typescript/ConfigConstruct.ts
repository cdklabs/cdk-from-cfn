...
export class ConfigConstruct extends Construct {
  ...
  public constructor(scope: Construct, id: string, props: ConfigConstructProps = {}) {
    super(scope, id);
    ...
    const configBucket = new s3.CfnBucket(this, 'ConfigBucket', {
      bucketName: `cdk-from-cfn-e2e-test-config-bucket-${cdk.Stack.of(this).account}-${cdk.Stack.of(this).region}`,
    });
