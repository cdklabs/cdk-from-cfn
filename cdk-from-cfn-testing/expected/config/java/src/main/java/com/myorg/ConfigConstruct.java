...
class ConfigConstruct extends Construct {
    ...
    public ConfigConstruct(final Construct scope, final String id) {
    ...
    public ConfigConstruct(final Construct scope, final String id,
        ...
        CfnBucket configBucket = CfnBucket.Builder.create(this, "ConfigBucket")
                .bucketName("cdk-from-cfn-e2e-test-config-bucket-" + Stack.of(this).getAccount() + "-" + Stack.of(this).getRegion())
                .build();
