...
func NewEfsConstruct(scope constructs.Construct, id string, props *EfsConstructProps) *EfsConstruct {
	/*
		...
		&ec2.CfnInternetGatewayProps{
			Tags: &[]*cdk.CfnTag{
				&cdk.CfnTag{
					...
					Value: cdk.Stack_Of(construct).StackName(),
				},
				&cdk.CfnTag{
	...
	vpc := ec2.NewCfnVPC(
		...
		&ec2.CfnVPCProps{
			...
			Tags: &[]*cdk.CfnTag{
				&cdk.CfnTag{
					Key: jsii.String("Application"),
					Value: cdk.Stack_Of(construct).StackId(),
				},
			},
		},
	)
