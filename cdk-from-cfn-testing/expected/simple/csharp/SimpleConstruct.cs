...
namespace SimpleConstruct
{
    public class SimpleConstructProps
    {
        /// <summary>
    ...
    /// </summary>
    public class SimpleConstruct : Construct
    {
        /// <summary>
        ...
        public SimpleConstruct(Construct scope, string id, SimpleConstructProps props = null) : base(scope, id)
        {
            // Applying default props
            props ??= new SimpleConstructProps();
            ...
            // Conditions
            bool isUs = Fn.Select(0, Fn.Split("-", Stack.Of(this).Region)) == "us";
            bool isUsEast1 = Stack.Of(this).Region == "us-east-1";
