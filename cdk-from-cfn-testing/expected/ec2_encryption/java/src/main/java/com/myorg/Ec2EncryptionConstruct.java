...
class Ec2EncryptionConstruct extends Construct {
    public Ec2EncryptionConstruct(final Construct scope, final String id) {
    ...
    public Ec2EncryptionConstruct(final Construct scope, final String id,
        ...
        CfnInstance myApp = CfnInstance.Builder.create(this, "MyApp")
                .imageId(regionToAmi.findInMap(Stack.of(this).getRegion(), "AMI"))
