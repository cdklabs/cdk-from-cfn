...
namespace CustomResourceConstruct
{
    public class CustomResourceConstructProps
    {
    }
    ...
    /// </summary>
    public class CustomResourceConstruct : Construct
    {
        public CustomResourceConstruct(Construct scope, string id, CustomResourceConstructProps props = null) : base(scope, id)
        {
