...
export interface GroundStationConstructProps {
  /**
 ...
 */
export class GroundStationConstruct extends Construct {
  public readonly snsTopicArn;

  public constructor(scope: Construct, id: string, props: GroundStationConstructProps = {}) {
    super(scope, id);
        ...
        Statement: [
          {
            ...
            Condition: {
              ...
              ArnLike: {
                'aws:SourceArn': `arn:aws:groundstation:${cdk.Stack.of(this).region}:${cdk.Stack.of(this).account}:config/s3-recording/*`,
              },
            },
          },
        ],
    ...
    const receiverInstance = new ec2.CfnInstance(this, 'ReceiverInstance', {
      ...
      imageId: amiMap[cdk.Stack.of(this).region]['ami'],
      ...
      export HOSTNAME=$(aws ec2 describe-tags --filters "Name=resource-id,Values=$INSTANCE" "Name=key,Values=Name" --region=${cdk.Stack.of(this).region} --output=text |cut -f5)
      ...
      aws s3 cp --region ${cdk.Stack.of(this).region} "s3://${props.softwareS3Bucket!}/software/RT-STPS/rt-stps-process.sh" "$PROCESS_SCRIPT"
      ...
      aws sns publish --topic-arn ${snsTopic.ref} --message "$MESSAGE" --region ${cdk.Stack.of(this).region}
        ...
        Statement: [
          {
            ...
            Resource: [
              `arn:aws:ec2:${cdk.Stack.of(this).region}:${cdk.Stack.of(this).account}:instance/${receiverInstance.ref}`,
            ],
          },
          {
            Effect: 'Allow',
