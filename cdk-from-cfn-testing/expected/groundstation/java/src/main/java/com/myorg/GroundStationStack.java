...
class GroundStationStack extends Stack {
    ...
    public GroundStationStack(final Construct scope, final String id) {
        super(scope, id, null);
    }

    public GroundStationStack(final Construct scope, final String id, final StackProps props) {
        this(scope, id, props, null, null, null, null, null, null, null, null);
    }
    ...
    public GroundStationStack(final Construct scope, final String id, final StackProps props,
        ...
        CfnRole groundStationS3DataDeliveryRole = CfnRole.Builder.create(this, "GroundStationS3DataDeliveryRole")
                .assumeRolePolicyDocument(Map.of("Statement", Arrays.asList(
                        ...
                        "ArnLike", Map.of("aws:SourceArn", "arn:aws:groundstation:" + this.getRegion() + ":" + this.getAccount() + ":config/s3-recording/*"))))))
                .build();
        ...
        CfnInstance receiverInstance = CfnInstance.Builder.create(this, "ReceiverInstance")
                ...
                .imageId(amiMap.findInMap(this.getRegion(), "ami"))
                ...
                export HOSTNAME=$(aws ec2 describe-tags --filters "Name=resource-id,Values=$INSTANCE" "Name=key,Values=Name" --region=" + this.getRegion() + " --output=text |cut -f5)
                ...
                aws s3 cp --region " + this.getRegion() + " "s3://" + softwareS3Bucket + "/software/RT-STPS/rt-stps-process.sh" "$PROCESS_SCRIPT"
                ...
                aws sns publish --topic-arn " + snsTopic.getRef() + " --message "$MESSAGE" --region " + this.getRegion() + "
        ...
        CfnManagedPolicy groundStationS3ddLambdaRolePolicy = CfnManagedPolicy.Builder.create(this, "GroundStationS3ddLambdaRolePolicy")
                ...
                "Statement", Arrays.asList(
                        ...
                        "Action", Arrays.asList(
                                ...
                                "ec2:CreateTags"),
                        "Resource", Arrays.asList(
                                "arn:aws:ec2:" + this.getRegion() + ":" + this.getAccount() + ":instance/" + receiverInstance.getRef())),
                        Map.of("Effect", "Allow",
                        "Action", Arrays.asList(
        ...
        CfnOutput.Builder.create(this, "CfnOutputSnsTopicArn")
                ...
                .exportName(this.getStackName() + "-SnsTopicArn")
                .build();
