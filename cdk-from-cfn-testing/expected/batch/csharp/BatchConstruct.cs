...
namespace BatchConstruct
{
    public class BatchConstructProps
    {
    }
    ...
    /// </summary>
    public class BatchConstruct : Construct
    {
        ...
        public BatchConstruct(Construct scope, string id, BatchConstructProps props = null) : base(scope, id)
        {
