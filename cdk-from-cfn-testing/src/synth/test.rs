...
use crate::{ClassTestCase, Language, Scope, Stack};
...
impl<'a> CdkAppTestCase<'a> {
    ...
    pub fn new(
        ...
        for lang in all_languages {
            ...
            let test_case = ClassTestCase::new(
                test_path,
                &lang,
                stack_name,
    ...
    pub fn from_scope(scope: &Scope, app: &CdkAppTestGroup<'a>) -> Self {
        ...
        let test_case = ClassTestCase::from_scope(scope, app.stack_name);
        Self {
    ...
    pub fn cdk_out_matches_cfn_class_file(&self) {
        Templates::validate(&self.test_case.scope, self.test_case.class_name);
    }
    ...
    pub fn generated_class_file_matches_expected(&self) {
        self.test_case.generated_class_file_matches_expected();
    }
}
