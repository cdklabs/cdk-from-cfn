...
mod tests {
    ...
    fn test_constructor_from() {
        ...
        assert_eq!(constructor.inputs[0].description, Some("description1".to_string()));
        assert_eq!(constructor.inputs[0].constructor_type, "String");
        assert_eq!(constructor.inputs[0].default_value, Some("default1".to_string()));

        assert_eq!(constructor.inputs[1].name, "param2");
        assert_eq!(constructor.inputs[1].description, Some("description2".to_string()));
