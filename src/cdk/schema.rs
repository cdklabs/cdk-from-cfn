...
pub struct Schema {
    ...
    /// The version of `aws-cdk-lib` this schema was derived from (informational).
...
impl Schema {
    ...
    /// Returns the version of `aws-cdk-lib` that this schema was built from.
                    ...
                    match key.as_str() {
                        ...
                        unknown => {
                            return Err(A::Error::unknown_field(
                                unknown,
                                &["listOf", "mapOf", "named", "primitive", "union"],
                            ))
                        }
                    }
                } else {
