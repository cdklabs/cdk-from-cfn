...
class CfnPartnerAccount(
    ...
    def __init__(
        ...
        *,
        ...
        sidewalk_response: typing.Optional[typing.Union[typing.Union["CfnPartnerAccount.SidewalkAccountInfoWithFingerprintProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
    ...
    def sidewalk_response(
        self,
    ) -> typing.Optional[typing.Union["CfnPartnerAccount.SidewalkAccountInfoWithFingerprintProperty", _IResolvable_da3f097b]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnPartnerAccount.SidewalkAccountInfoWithFingerprintProperty", _IResolvable_da3f097b]], jsii.get(self, "sidewalkResponse"))

    @sidewalk_response.setter
    def sidewalk_response(
        self,
        value: typing.Optional[typing.Union["CfnPartnerAccount.SidewalkAccountInfoWithFingerprintProperty", _IResolvable_da3f097b]],
    ) -> None:
        if __debug__:
...
class CfnPartnerAccountProps:
    ...
    def sidewalk_response(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnPartnerAccount.SidewalkAccountInfoWithFingerprintProperty, _IResolvable_da3f097b]], result)
