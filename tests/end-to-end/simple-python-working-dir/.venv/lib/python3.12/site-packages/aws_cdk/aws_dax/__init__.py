...
class CfnCluster(
    ...
    def __init__(
        ...
        *,
        ...
        sse_specification: typing.Optional[typing.Union[typing.Union["CfnCluster.SSESpecificationProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
