...
class CfnSigningProfile(
    ...
    def __init__(
        ...
        *,
        ...
        signature_validity_period: typing.Optional[typing.Union[typing.Union["CfnSigningProfile.SignatureValidityPeriodProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
